...
class StockTradingEnv(gym.Env):
    ...
    def step(self, actions):
        ...
        if self.terminal:
            ...
            df_total_value = pd.DataFrame(self.asset_memory)  # 每天資產總額
            ...
            if self.episode % self.print_verbosity == 0:
                ...
                print(
                    f"daily_return_std: {df_total_value['daily_return'].std():0.3f}")
                if df_total_value['daily_return'].std() != 0:
            ...
            self.day += 1
            self.data = self.df.loc[self.day, :]  # sort by date and tic first
            if self.turbulence_threshold is not None:
